...
public class FacilityForm {
    ...
    private Long account_id_agreed_new; // 신규요청 승인한 계정
    private Long account_id_agreed_edit; // 수정요청 승인한 계정


    public Facility toEntity(FacilityCategoryRepository facilityCategoryRepository, UserRepository userRepository_new, UserRepository userRepository_edit) {
